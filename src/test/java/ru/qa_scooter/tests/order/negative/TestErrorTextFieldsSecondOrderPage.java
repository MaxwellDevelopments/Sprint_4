...
public class TestErrorTextFieldsSecondOrderPage extends BaseTestAfterAndBeforeClass {
    ...
    // Далее идут заготовки для тестов на будущие ошибки

//    @Test
//    public void shouldErrorFieldDateBeVisible() {
//        boolean expected = true;
//        boolean actual;
//        String message = "Элемент не появился";
//
//
//        objSecondOrderPage.setDateByInput(order.getDate());
//        objSecondOrderPage.clickOnNextButton();
//        confirmPageOrderIsNotOpened();
//
//        actual = objSecondOrderPage.getWebElemVisibleByText(objSecondOrderPage.getDateError());
//
//        MatcherAssert.assertThat(
//                message,
//                actual,
...
//
//    @Test
//    public void shouldErrorTextDateBeLikeParameter() {
//        String actual;
//        String message = "Неправильный текст ошибки у поля Имя";
//
//        objSecondOrderPage.setDateByInput(order.getDate());
//        objSecondOrderPage.clickOnNextButton();
//        confirmPageOrderIsNotOpened();
//
//        actual = objSecondOrderPage.getDateError();
//
//        MatcherAssert.assertThat(
//                message,
//                actual,
...
//
//    @Test
//    public void shouldErrorFieldRentTimeBeVisible() {
//        boolean expected = true;
//        boolean actual;
//        String message = "Элемент не появился";
//
//
//        objSecondOrderPage.setRentTime(order.getRentTime());
//        objSecondOrderPage.clickOnNextButton();
//        confirmPageOrderIsNotOpened();
//
//        actual = objSecondOrderPage.getWebElemVisibleByText(objSecondOrderPage.getRentTimeError());
//
//        MatcherAssert.assertThat(
//                message,
//                actual,
...
//
//    @Test
//    public void shouldErrorTextRentTimeBeLikeParameter() {
//        String actual;
//        String message = "Неправильный текст ошибки у поля Фамилия";
//
//        objSecondOrderPage.setRentTime(order.getRentTime());
//        objSecondOrderPage.clickOnNextButton();
//        confirmPageOrderIsNotOpened();
//
//        actual = objSecondOrderPage.getRentTimeError();
//
//        MatcherAssert.assertThat(
//                message,
//                actual,
